...
class ScrollBar(object):
    def __init__(self, image_height):
        ...
        self.bar_up_image = pygame.image.load(r"C:\Users\sever\Documents\Galactica-RTS_zoomable1.107\assets\pictures\icons\arrow-left.png").convert()
        self.bar_down_image = pygame.image.load(r"C:\Users\sever\Documents\Galactica-RTS_zoomable1.107\assets\pictures\icons\arrow-right.png").convert()
...
def main():
    ...
    # Load Image:
    image = pygame.image.load(r"C:\Users\sever\Documents\Galactica-RTS_zoomable1.107\assets\pictures\icons\yes_icon.png").convert()
    ...
    while not done:
        ...
        pygame.display.update([scrollbar.bar_rect, scrollbar.bar_up, scrollbar.bar_down])
