...
zlib_data = base64.b64decode(compressed)
size, image_mode, raw = (128, 128), 'RGBA', zlib.decompress(zlib_data)
...
other = pygame.image.fromstring(pil_blured.tobytes("raw", image_mode), size, image_mode)
