...
from source.pan_zoom_sprites.pan_zoom_sprite_base.pan_zoom_sprite_classes import PanZoomImage, \
    PanZoomFlickeringStar, PanZoomPulsatingStar, PanZoomMovingRotatingSprite, PanZoomMovingGif, PanZoomGif
...
class UniverseFactory:
    ...
    def create_asteroids(self) -> None:
        ...
        for i in range(max(1, int(self.amount / ASTEROID_DIVIDE_FACTOR))):
            ...
            self.asteroid.append(PanZoomMovingRotatingSprite(
                    win=self.win,
                    world_x=x,
                    world_y=y,
                    world_width=w,
        ...
        #     movement_speed = random.uniform(ASTEROID_MIN_SPEED, ASTEROID_MAX_SPEED)
        #
        #     self.asteroid.append(PanZoomMovingGif(
        #             win=self.win,
        #             world_x=x,
        #             world_y=y,
        #             world_width=w,
    ...
    def create_comets(self) -> None:
        ...
        for i in range(max(1, int(self.amount / COMET_DIVIDE_FACTOR))):
            ...
            self.comet.append(PanZoomMovingRotatingSprite(
                    win=self.win,
                    world_x=x,
                    world_y=y,
                    world_width=w,
        ...
        for i in range(max(1, int(self.amount / COMET_DIVIDE_FACTOR))):
            ...
            self.comet.append(PanZoomMovingGif(
                    win=self.win,
                    world_x=x,
                    world_y=y,
                    world_width=w,
