...
def navigate_to__(obj, **kwargs):
    ...
    if not obj and ship:
        ...
        first_item = sprite_groups.ships.sprites().pop(0)
        sprite_groups.ships.sprites().append(first_item)
        print (sprite_groups.ships.sprites())
