...
class BoxSelection:
    ...
    def select_objects(self):
        ...
        [other.select(False) for other in self.selectable_objects if
         other not in self.selected_objects and other != global_params.app.ship]
    ...
    def listen(self, events):
        ...
        if global_params.hover_object:
            if not hasattr(global_params.hover_object, "property") or hasattr(global_params.hover_object, "drag_enabled"):
                return
