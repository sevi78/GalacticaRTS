...
class DebugEdit(EditorBase):
    ...
    def create_checkboxes(self):
        ...
        checkbox_missiles = Checkbox(
                ...
                key="missiles", image_name="missile.png", tooltip="debug missiles", on_click=lambda: print("OKOKOK"), layer=9, parent=self)
        x += BUTTON_SIZE * 1.5
        ...
        checkbox_ships = Checkbox(
                self.win, self.world_x - self.spacing_x + x + BUTTON_SIZE * 3, y, 30, 30, is_sub_widget=False,
                color=self.frame_color,
                key="ships", image_name="spaceship.png", tooltip="debug spaceships", on_click=lambda: print("OKOKOK"), layer=9, parent=self)
        x += BUTTON_SIZE * 1.5
        ...
        checkbox_planets = Checkbox(
                self.win, self.world_x - self.spacing_x + x + BUTTON_SIZE * 3, y, 30, 30, is_sub_widget=False,
                color=self.frame_color,
                key="planets", image_name="Zeta Bentauri_60x60.png", tooltip="debug planets", on_click=lambda: print("OKOKOK"), layer=9, parent=self)
        x += BUTTON_SIZE * 1.5
        ...
        checkbox_ufos = Checkbox(
                self.win, self.world_x - self.spacing_x + x + BUTTON_SIZE * 3, y, 30, 30, is_sub_widget=False,
                color=self.frame_color,
                key="ufos", image_name="ufo_74x30.png", tooltip="debug ufos", on_click=lambda: print("OKOKOK"), layer=9, parent=self)
        x += BUTTON_SIZE * 1.5
        ...
        checkbox_celestials = Checkbox(
                self.win, self.world_x - self.spacing_x + x + BUTTON_SIZE * 3, y, 30, 30, is_sub_widget=False,
                color=self.frame_color,
                key="celestials", image_name="asteroid_40x33.png", tooltip="debug celestial objects", on_click=lambda: print("OKOKOK"), layer=9, parent=self)
        x += BUTTON_SIZE * 1.5
        ...
        checkbox_collectable_items = Checkbox(
                self.win, self.world_x - self.spacing_x + x + BUTTON_SIZE * 3, y, 30, 30, is_sub_widget=False,
                color=self.frame_color,
                key="collectable_items", image_name="meteor_60x83.png", tooltip="debug collectable items", on_click=lambda: print("OKOKOK"), layer=9, parent=self)
        x += BUTTON_SIZE * 1.5
        ...
        debug_checkbox = Checkbox(
                self.win, self.world_x - self.spacing_x + x + BUTTON_SIZE * 3, y, 30, 30, is_sub_widget=False,
                color=self.frame_color,
                key="debug_icon", image_name="debug_icon.png", tooltip="debug", on_click=lambda: print("debug: ",
    ...
    def create_layer_checkboxes(self):
        ...
        for i in range(len(WidgetHandler.layer_switch.keys())):
            checkbox = Checkbox(
                    ...
                    on_click=lambda: print("not working"),
                    layer=10,
                    parent=self,
