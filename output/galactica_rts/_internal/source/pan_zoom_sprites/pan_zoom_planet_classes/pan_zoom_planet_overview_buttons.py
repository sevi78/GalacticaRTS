...
class PanZoomPlanetOverviewButtons():
    ...
    def create_overview_buttons(self):
        ...
        self.thumpsup_button = Button(
                ...
                image=pygame.transform.flip(scale_image_cached(get_image(
        ...
        self.smiley_button = Button(
                ...
                parent=self.parent,
                ui_parent=self,
                tooltip="indicates the satisfaction of the population",
                image=get_image("smile.png"),
                layer=7,
                zoomable=False)
        ...
        # technology_level
        self.technology_level_button = Button(
                self.win,
                x=0,
                y=0,
                width=self.smiley_button_size[0],
                ...
                parent=self.parent,
                ui_parent=self,
                tooltip=f"indicates the technology_level of the population:{id(self)}",
                image=get_image("badge1.png"),
                layer=7,
                zoomable=False)

        self.overview_buttons.append(self.technology_level_button)

        self.planetary_defence_button = Button(
                self.win,
                x=0,
                y=0,
                width=self.smiley_button_size[0],
                ...
                parent=self.parent,
                ui_parent=self,
                tooltip="indicates if planetary defence is built",
                image=get_image("planet defence.png"),
                layer=7,
                zoomable=False,
        ...
        for i in self.overview_buttons:
            if self.explored:
                if not self.type == "sun":
                    if pan_zoom_handler.get_zoom() > 0.2:
                        i.show()
                        i.enable()
    ...
    def set_overview_images(self):
        try:
            if self.thumpsup_status:
                self.thumpsup_button.image_raw = pygame.transform.flip(scale_image_cached(
                        get_image(
    ...
    def handle_overview_buttons(self):
        ...
        if not config.show_overview_buttons or self._hidden:
            self.hide_overview_button()
